...
import (
	...
	"github.com/sqlserverio/go-mssqldb"
)
...
func main() {
	...
	stmt, err := txn.Prepare(mssql.CopyIn("test_table", mssql.BulkInsertOptions{}, "test_varchar", "test_nvarchar", "test_float", "test_bigint"))
	if err != nil {
		log.Fatal(err.Error())
	}
